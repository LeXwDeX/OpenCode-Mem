...
export interface SettingsDefaults {
  ...
  CLAUDE_MEM_PROVIDER: string;  // 'claude' | 'gemini' | 'openrouter' | 'azure'
  ...
  CLAUDE_MEM_AZURE_OPENAI_API_KEY: string;
  CLAUDE_MEM_AZURE_OPENAI_ENDPOINT: string;
  CLAUDE_MEM_AZURE_OPENAI_MODEL: string;
  CLAUDE_MEM_AZURE_OPENAI_API_VERSION: string;
...
export class SettingsDefaultsManager {
  ...
  private static readonly DEFAULTS: SettingsDefaults = {
    ...
    CLAUDE_MEM_AZURE_OPENAI_API_VERSION: '2024-10-21',
    // System Configuration
