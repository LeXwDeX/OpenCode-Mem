    ...
    fetch(API_ENDPOINTS.SETTINGS)
      ...
      .then(data => {
        setSettings({
          ...
          CLAUDE_MEM_AZURE_OPENAI_API_KEY: data.CLAUDE_MEM_AZURE_OPENAI_API_KEY || DEFAULT_SETTINGS.CLAUDE_MEM_AZURE_OPENAI_API_KEY,
          CLAUDE_MEM_AZURE_OPENAI_ENDPOINT: data.CLAUDE_MEM_AZURE_OPENAI_ENDPOINT || DEFAULT_SETTINGS.CLAUDE_MEM_AZURE_OPENAI_ENDPOINT,
          CLAUDE_MEM_AZURE_OPENAI_MODEL: data.CLAUDE_MEM_AZURE_OPENAI_MODEL || DEFAULT_SETTINGS.CLAUDE_MEM_AZURE_OPENAI_MODEL,
          CLAUDE_MEM_AZURE_OPENAI_API_VERSION: data.CLAUDE_MEM_AZURE_OPENAI_API_VERSION || DEFAULT_SETTINGS.CLAUDE_MEM_AZURE_OPENAI_API_VERSION,
